...
\author{Lucas DUBOIS, Myriam LAMBORELLE, William LEMAIRE \& Tom PARMENTIER}
\institute{HEC Liège}
\date{\today}
...
\begin{frame}{\textsc{Objectives:}}
    The paper {\color{primaryred}"Empirical Asset Pricing via Machine Learning"} \cite{gu_empirical_2020} has a twofold objective:
  \begin{enumerate}
   \item Setting {\color{steelblue} new benchmarks} to compare ML methods for asset pricing.
